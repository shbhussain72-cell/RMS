    ...
    <BottomSheet
      ...
      footer={
        <div className="flex gap-[10px]">
          ...
          >
            <span className="text-[15px] font-bold text-white" style={{ fontFamily: FONT }}>Yes, confirm</span>
          </button>
        </div>
      }
    >
      <div className="flex flex-col items-center px-[6px] pt-[8px] pb-[4px] text-center">
        ...
        <h2 className="mt-[16px] text-[24px] leading-[30px] text-[#15402f]" style={{ fontFamily: SERIF }}>
          You missed some members
        </h2>
