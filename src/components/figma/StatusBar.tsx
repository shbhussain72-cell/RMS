...
export default function StatusBar({ tone = "light" }: { tone?: Tone }) {
  ...
  return (
    <div className="relative h-[44px] w-full shrink-0" data-node-id="29:1998" data-name="status-bar">
      ...
      {/* Cellular */}
      <div className="absolute right-[64.33px] top-[calc(50%+1px)] -translate-y-1/2 h-[10.669px] w-[17px]" style={{ color }} data-name="Cellular">
      ...
      {/* Wifi */}
      <div className="absolute right-[44.03px] top-[calc(50%+0.81px)] -translate-y-1/2 h-[10.968px] w-[15.272px]" style={{ color }} data-name="Wifi">
      ...
      {/* Battery */}
      <div className="absolute right-[14.67px] top-[calc(50%+1px)] -translate-y-1/2 h-[11.333px] w-[24.328px]" style={{ color }} data-name="Battery">
        ...
        <div
          className="absolute right-[4.33px] top-1/2 h-[7.333px] w-[18px] -translate-y-1/2 rounded-[1.333px]"
