 ...
 *     حح → چ      ضض → ٹ      طط → ں
 *
 * This is NOT damage in the sense `src/dev/mojibake.mjs` means. Nothing was mis-decoded and
 ...
 * shipped app calls it. `src/dev/mojibake.mjs` escapes the same fate only because its strings
